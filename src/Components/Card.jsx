...
const Card = ({ img, name, price, price2 }) => {
  return (
    <div className='border-b md:border-none pb-5 md:pb-20'>
        ...
        <button className='my-5 transition-all duration-500 hover:scale-110 py-1 px-8 mx-auto text-white border text-xl w-max border-white rounded-full'>Beli Sekarang</button>
    </div>
  )
}
