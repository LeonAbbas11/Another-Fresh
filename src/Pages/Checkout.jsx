...
const Checkout = () => {
    ...
    const uniqueID = v4();
    const resID = uniqueID.slice(0, 8);
    ...
    console.log(data);
    localStorage.setItem('idUnik', data.id_pembelian);
    ...
    useEffect(()=>{
        ...
        setTotal(39000 * data.qty)
        } else if (data.buah === '2'){
        setTotal(77000 * data.qty)
        } else {
        setTotal(40000 * data.qty)
        }
    }, [data.qty, data.buah])
        ...
        try {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        title: "Sukses!",
                        text: "Pesanan anda akan segera di proses, tim kami akan menghubungi anda segera.",
                        icon: "success"
                });
                }
            });
        ...
        <div className="wrapper w-11/12 mx-auto grid text-white my-10 xl:my-5">
            ...
            <div className="wrapperForm w-full lg:w-9/12 xl:w-1/2 mx-auto mt-5 lg:mt-20 xl:mt-10 border rounded-lg p-3 space-y-5 lg:space-y-8 xl:space-y-2">
                ...
                <div className="flex">
                    ...
                    <div className="grid xl:mx-auto xl:w-3/4 xl:ml-10">
                        <p className='mb-1 text-start'>Harga</p>
                        <div className='px-2 py-1 rounded border bg-white'>
                            <p className='text-start text-black font-semibold'>Rp. { total }</p>
                        </div>
                    </div>
                </div>
            </div>
